...
export const ecologyReducer = createSlice({
    name:"admin",
    initialState:ecologyInitState,
    reducers:{
...
export const {pageInfoLoaded, loading, errorOccurred,mapInfoLoaded,loadedInstitutionTypes,markersLoaded} = ecologyReducer.actions;
export default ecologyReducer.reducer;
